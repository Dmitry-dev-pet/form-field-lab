...
export const COMMUNITY_GENES = Object.freeze([
  {
    ...
    inheritance: "Тридцать эллиптических колец образуют тело, двадцать поперечных сечений продолжают его в хвостовой плавник.",
  ...
  },
  {
    ...
    inheritance: "Одна глубинная фаза согласованно изгибает кольца тела и хвост, а не дёргает случайные точки.",
  ...
  },
  {
    ...
    inheritance: "Отделяющиеся агенты исследованы как возможное продолжение, но не входят ни в один текущий RAW Пелагиона.",
  ...
  },
  {
    ...
    inheritance: "Угол θ обходит каждое сечение, а независимая координата z делает центр выпуклым и несёт волну гребка.",
  ...
  },
  {
    ...
    inheritance: "Шлейф памяти остаётся исследованным расширением и сознательно не дорисовывается поверх автономного RAW.",
  ...
  },
  {
    ...
    inheritance: "Хвостовой плавник связан с корпусом, но получает собственное запаздывание и большую амплитуду глубины.",
  ...
  },
  {
    ...
    inheritance: "Касание и перетаскивание вращают камеру вокруг уже существующего тела и не изменяют геном или движение.",
