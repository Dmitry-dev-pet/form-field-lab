...
<template>
  <section class="view">
    <header class="view-head">
      ...
      <p class="view-lead">Подтверждённая подборка однотвитовых p5.js-работ. Исторические номера №01–35 сохранены; ранний stateful-скетч добавлен как №36 после прямой проверки публикации. Выбранная формула запускается в изолированном контейнере.</p>
    </header>
