      ...
      <div class="seed-lab">
        ...
        <div class="seed-copy">
          <div>
            ...
            <p>Автономный скетч уже содержит читаемое тело, хвостовой плавник, формульный цвет, движение и настоящую координату <code>z</code>. Лаборатория исполняет эту строку напрямую и позволяет сравнить её с RAW силового гребка.</p>
          </div>
