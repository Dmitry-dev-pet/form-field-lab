      ...
      <div class="seed-lab">
        ...
        <div class="seed-copy">
          <div>
            ...
            <p>Это точный цельный «Живой гребок RAW» из версии <code>34fe67e</code>: единый профиль оболочки, формульный цвет, движение и настоящая координата <code>z</code>. Лаборатория всегда начинает именно с него; 512 дописывает яркий внутренний орган, а 768 — контрастную поперечно-продольную сетку, не меняя исходный слой.</p>
          </div>
