      ...
      <article id="torophore" class="theory-card pelagion-theory chronophore-theory">
        ...
        <div class="theory-body pelagion-theory-grid">
          ...
          <div class="pelagion-genome">
            ...
            <p>Стенд открывается в 246-символьном режиме «Лагуна» с <code>X=2, Y=3, Z=1</code>: цвет от фазы <code>d</code> и три вращения уже находятся внутри RAW, поэтому движение видно сразу. Девять основных ползунков меняют перенос, число торов, фазу, большой радиус, дыхание, интенсивность цвета и три RAW-вращения; в точной настройке остаётся сглаживание шума. Original, «Лагуна», «Огонь» и «Плазма» даже в крайних комбинациях сохраняют лимит 280.</p>
            <div class="pelagion-links">
        ...
        <div class="tiny-code-context">
          ...
          <p><strong>Цвет как движение.</strong> Каналы RGB вычисляются из той же фазы <code>d</code>, которая раскладывает торы, поэтому цветовой рисунок переносится вместе с формой. Палитра и интенсивность находятся внутри RAW.</p>
